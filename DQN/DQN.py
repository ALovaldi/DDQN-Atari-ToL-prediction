...
def get_config(model):
    ...
    return TrainConfig(
        ...
        model=model,
        callbacks=[
            PeriodicTrigger(ModelSaver(), every_k_epochs=4),
            PeriodicTrigger(
            ...
            ScheduledHyperParamSetter(
                ...
                [(0, 0.1)],   # 1->0.1 in the first million steps
                interp='linear'),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ntrain', default='')
    ...
    if args.task != 'train':
        ...
        logger.set_logger_dir(os.path.join('train_log', 'DQN-{}-{}'.format(os.path.basename(args.env).split('.')[0], args.ntrain)))
